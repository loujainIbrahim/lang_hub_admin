    ...
    return BlocProvider(
      ...
      child: BlocConsumer<ProfileCubit, ProfileState>(
        listener: (context, state) {
          if(state is ProfileSuccessState)print("succcccccesss profilllllllle");
        ...
        builder: (context, state) {
          return ConditionalBuilder(
              ...
              builder: (context) {
                final profileModel = ProfileCubit.get(context).profileModel!;
                ...
                print(photo);
                final eng = (profileModel!.data!.academyInfo!.english == 0)
                    ? false
                    : true;
                final frensh = (profileModel!.data!.academyInfo!.french == 0)
                    ? false
                    : true;
                final grem = (profileModel!.data!.academyInfo!.germany == 0)
                    ? false
                    : true;
                final spanish = (profileModel!.data!.academyInfo!.spanish == 0)
                    ? false
                    : true;
